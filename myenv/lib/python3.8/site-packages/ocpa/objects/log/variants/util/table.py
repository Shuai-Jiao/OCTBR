...
def eog_from_log(table_log):
    ...
    edge_list = []
    #print('list(ocel.columns.values):------',list(ocel.columns.values),table_log.object_types)
    ...
    arr = ocel.to_numpy()
    #print("check ocel to numpy",arr[:2],ocel.head(2))
    last_ev = {}
        ...
        for ot in table_log.object_types:
            for o in arr[i][ot_index[ot]]:
                if (ot, o) in last_ev.keys():
                    ...
                    #print('EOG---------',(edge_source, edge_target))

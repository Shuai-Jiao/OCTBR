...
def apply(ocel, return_obj_df=True, parameters=None):
    ...
    for ev in events:
        ...
        # because the object type is added according to the object! in the new\
        # generated log, many events are removed, so many objects are also removed!\
        # then some object types will be missing.
        for k2 in new_omap:
            el[k2] = new_omap[k2]

...
def apply(ocel: OCEL, parameters: Optional[Dict[Any, Any]] = None) -> Dict[str, Any]:
    ...
    #print('ret["object_types"]:',ret["object_types"])

    ret["edges"] = {}
    ret["edges"]["event_couples"] = edge_metrics.aggregate_ev_couples(edges)
    #print('ret["edges"]["event_couples"].keys()----',ret["edges"]["event_couples"].keys())
    #ret["edges"]["event_couples"] is tuple of transitions. But some object types are missing as a key.

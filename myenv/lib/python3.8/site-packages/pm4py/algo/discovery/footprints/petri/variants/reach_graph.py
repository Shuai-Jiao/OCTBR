...
def apply(net: PetriNet, im: Marking, parameters: Optional[Dict[Any, Any]] = None) -> Dict[str, Any]:
    ...
    #print('/Users/jiao.shuai.1998.12.01outlook.com/opt/anaconda3/lib/python3.8/site-packages/pm4py/algo/discovery/footprints/petri/variants/reach_graph.py65',incoming_transitions,'\n----',outgoing_transitions,'\n----',eventually_enabled )
    sequence = set()
    #print(net,im,'line67')
    #print(incoming_transitions, outgoing_transitions, eventually_enabled,'line68')
    s1 = set()
    s2 = set()
    ...
    #print(activities,'activities',sequence,'seq',start_activities,parallel)

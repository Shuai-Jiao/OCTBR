...
def marking_flow_petri(net, im, return_eventually_enabled=False, parameters=None):
    ...
    active = [im]
    #print('/Users/jiao.shuai.1998.12.01outlook.com/opt/anaconda3/lib/python3.8/site-packages/pm4py/objects/petri_net/utils/reachability_graph.py')
    #print('-----active',active)
    while active:
        ...
        #print('------enabled_transitions',enabled_transitions)
